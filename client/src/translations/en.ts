export const en = {
  ...
  poweredByPayPal: 'Secure payment powered by PayPal - Industry-leading security',
  sslEncrypted: 'SSL Encrypted',
  pciCompliant: 'PCI Compliant',
  liveProcessing: 'Live Processing',
  allPaymentMethodsAccepted: 'PayPal, Credit/Debit Card, Apple Pay, Google Pay',
  securePaymentProcessing: 'Secure Payment Processing',
  redirectToPayPal: 'Choose your preferred payment method on the next page',
  continueToSecureCheckout: 'Continue to Secure Checkout',
  redirectingToPayPal: 'Redirecting to secure payment...',
  ...
  availableContactMethods: 'Available Contact Methods',
  contactInfoPurchaseNote: 'Contact information is revealed after purchase and verified for authenticity',
  contactPricing: 'Contact Pricing',
  individualContact: 'Individual Contact',
  bulkDiscount: 'Bulk Discount',
  contactsRange1to9: '1-9 contacts',
  contactsRange10plus: '10+ contacts',
  ...
  replacementContactInfo: "Can I get a replacement for any incorrect contact information provided?",
  replacementContactInfoAnswer: "Yes, if the contact information provided is incorrect or outdated, please contact us with details and we'll provide replacement information at no additional cost.",
  refundIncorrectInfo: "Can I get a refund if the contact information is not correct?",
  refundIncorrectInfoAnswer: "We offer full refunds for verified incorrect contact information. Please contact us within 30 days with proof of the issue.",
  currentContactInfo: "How current is the information for the specific contact I want to purchase?",
  currentContactInfoAnswer: "Contact information is regularly updated and verified. Most information is current within 30 days, with frequent verification of active profiles.",
  ...
  // Report Issue page
  reportPageTitle: "Report an Issue | HolaCupid",
  reportPageDescription: "Report inappropriate behavior, safety concerns, or technical issues on HolaCupid. Our team reviews all reports within 24 hours.",
  reportAnIssue: "Report an Issue",
  reportSubtitle: "Help us maintain a safe and respectful community. Report any inappropriate behavior, safety concerns, or technical issues.",
  reportTypes: {
  ...
  reportDescriptions: {
    harassment: "Report harassment, threats, or inappropriate messages",
    inappropriate: "Report inappropriate photos or profile content",
    fake: "Report fake profiles or stolen photos",
    scam: "Report scam attempts or fraudulent behavior",
    safety: "Report safety threats or suspicious activity",
    technical: "Report website bugs or technical issues",
    payment: "Report payment issues or billing problems",
    other: "Report other concerns or issues"
  },
  submitReport: "Submit a Report",
  typeOfReport: "Type of Report *",
  selectReportType: "Select report type",
  profileIdOrName: "Profile ID or Name (if applicable)",
  profileIdPlaceholder: "If reporting about a specific profile, provide the profile ID or name",
  profileIdHelp: "If reporting about a specific profile, please provide the profile ID or name",
  descriptionLabel: "Description *",
  descriptionPlaceholder: "Please provide details about the issue you're reporting...",
  additionalEvidence: "Additional Evidence",
  evidenceHelp: "Upload screenshots or documents that support your report",
  submitAnonymously: "Submit this report anonymously",
  yourEmailAddress: "Your Email Address *",
  emailPlaceholder: "We'll use this to follow up on your report",
  submitReportButton: "Submit Report",
  falseReportsWarning: "All reports are reviewed by our team. False reports may result in account restrictions.",
  whatHappensNext: "What happens after you report?",
  processSteps: [
    "We receive and review your report within 24 hours",
    "Our team investigates the reported issue or behavior",
    "We take appropriate action based on our findings",
    "You receive a follow-up email about the resolution"
  ],
