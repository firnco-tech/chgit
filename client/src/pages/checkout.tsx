      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-yellow-800">Test Mode - Use Test Cards Only</h3>
              <div className="mt-2 text-sm text-yellow-700">
                <p>This system is in test mode. Please use test card numbers:</p>
                ...
                <p className="mt-2 text-xs">Real credit cards will be declined in test mode.</p>
              </div>
            </div>
          </div>
        </div>
